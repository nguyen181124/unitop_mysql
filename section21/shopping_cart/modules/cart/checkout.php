                                ...
                                <div class="detail">
                                        ...
                                        ?>
                                            <tbody>
                                                <tr class="cart-item">
                                                    ...
                                                    <?php echo currency_format($item['sub_total'], 'đ') ?></td>
                                                </tr>
                                            </tbody>
                                            <?php
                                    }
                                    ?>
                                            <tfoot>
                                                <tr class="order-total">
                                                    <td>Tổng đơn hàng:</td>
                                                    <td><strong
                                                            class="total-price"><?php echo currency_format(get_total_cart(), 'đ'); ?></strong>
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    <div id="payment-checkout-wp">
                                        <ul id="payment_methods">
                                            <li>
                                                <input type="radio" checked="checked" id="direct-payment" name="payment"
                                                    value="online">
